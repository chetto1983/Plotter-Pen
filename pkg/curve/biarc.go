...
// FitSimpleArc fits arcs and lines to a sequence of points using a greedy approach.
...
// PointToLineDistance calculates perpendicular distance from point to line segment
