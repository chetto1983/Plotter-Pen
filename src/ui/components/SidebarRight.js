      ...
      <div class="cad-panel-section cad-panel-fill" id="plcPanel">
        <div class="cad-panel-header">
           ...
           <div class="cad-panel-actions">
              <button type="button" class="cad-icon-btn-sm" id="btnSimulate" title="Simula"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="5 3 19 12 5 21 5 3" /></svg></button>
