...
|-----------|------|--------|-------------|
| DXF Import | `internal/service/import/dxf.go` | Done | Parse entities, arc fitting, unit detection |
| DXF Export | `internal/service/import/dxf.go` | Done | Export primitives to DXF format |
...
| Arc Fitting | `internal/service/plc/fit.go` | Done | 3-point circle, tolerance-based fitting |
| Path Optimizer | `internal/service/plc/optimizer.go` | Done | Nearest-neighbor TSP |
| PLC Extractor | `internal/service/plc/extractor.go` | Done | J/L/A/WAIT with Z-axis |
| G-Code Gen | `pkg/gcode/generator.go` | Done | G0/G1/G2/G3/M codes |
| Clipper2 | `pkg/clipper/adapter.go` | Done | Polygon offsetting |
...
| Config | `internal/service/opcua/config.go` | Done | Multi-PLC support |
...
| MachineConfig | Done | Multi-machine support |
