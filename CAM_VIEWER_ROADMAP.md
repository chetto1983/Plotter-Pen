...
### Phase 1: G-code becomes first-class (done)
...
### Phase 3: UI and 3D polish (in progress)
...
- Arc preview fidelity matches the G2/G3 intent. (Done: Decoupled linearization strategy)
Exit criteria:
