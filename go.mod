...
require (
	github.com/StefanSchroeder/LeastSquareCircleFit v0.0.0-20151224193955-c37523041d1c // indirect
	...
	github.com/erdelmaero/ransac v0.0.0-20171013102837-2b0d4438ab65 // indirect
